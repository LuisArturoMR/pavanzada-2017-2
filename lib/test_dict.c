...
static char * testUpsertDictionary() {
  ...
  muAssert("myDictionary errorCode must be 0", *((int *)myDictionary->elements[0].value) == value); // el contenido de esta dirección que es de valor entero sea igual a value
  return 0;
}
